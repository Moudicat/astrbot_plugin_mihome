...
MODEL_PROFILES: Dict[str, Dict[str, Any]] = {
    ...
    # 保留对该型号的精确命中，但主体能力与通用扫地机模板保持一致
    "xiaomi.vacuum.ov21cn": {
        "category": CATEGORY_VACUUM,
        "hidden_props": [],
        "prop_map": CATEGORY_PROFILES[CATEGORY_VACUUM]["prop_map"],
        "value_map": CATEGORY_PROFILES[CATEGORY_VACUUM]["value_map"],
        "display_map": CATEGORY_PROFILES[CATEGORY_VACUUM]["display_map"],
        "detail_writable": CATEGORY_PROFILES[CATEGORY_VACUUM]["detail_writable"],
        "detail_readable": CATEGORY_PROFILES[CATEGORY_VACUUM]["detail_readable"],
        "action_map": CATEGORY_PROFILES[CATEGORY_VACUUM]["action_map"],
        "detail_actions": CATEGORY_PROFILES[CATEGORY_VACUUM]["detail_actions"],
        "help_examples": CATEGORY_PROFILES[CATEGORY_VACUUM]["help_examples"],
        "action_examples": CATEGORY_PROFILES[CATEGORY_VACUUM]["action_examples"],
        "help_hints": CATEGORY_PROFILES[CATEGORY_VACUUM]["help_hints"],
    },
